        ...
        child: Row(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  SizedBox(height: 3),
                  Text('Enter your registered email',style:TextStyle(fontSize: 18,fontWeight: FontWeight.w500,fontFamily: 'ubuntu',color: Color(0xff292929))),
                  SizedBox(height: 20),
                  Container(
                    width: 299,
                  ...
                  SizedBox(height:75 ),
                  Text('Verify email',style: Ubun_500_18_A3),
                  SizedBox(height:65 ),
