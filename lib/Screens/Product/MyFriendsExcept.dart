...
class MyFriendsExcept extends StatefulWidget {
  const MyFriendsExcept({super.key});

  @override
  State<MyFriendsExcept> createState() => _MyFriendsExceptState();
}

class _MyFriendsExceptState extends State<MyFriendsExcept> {
  bool _accepted= true;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title:Column(
          ...
          children: [
            Text('My friends except......',style:robo_500_16_33,),
            Text('1 excluded',style: robo_400_12_00,)
          ])),
      body: Padding(
